// Copied from https://raw.githubusercontent.com/deadlyfingers/UnityWav/
// Edited for MafiaUnity
...
namespace MafiaUnity
{
	namespace MafiaFormats
	{
        ...
        public class WAVLoader
		{
			...
			{
				var audioStream = GameAPI.instance.fileSystem.GetStreamFromPath(Path.Combine("sounds", name + ".wav"));
				...
				byte[] fileBytes = audioReader.ReadBytes((int)audioReader.BaseStream.Length);
